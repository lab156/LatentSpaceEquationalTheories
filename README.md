...
* `IMPORTED_DATA_PATH`: where you want to store the data imported form the original equational theories project.
* `GENERATED_DATA_PATH`: path to store generated data: Stone Pairs, Implication Graphs, etc.
